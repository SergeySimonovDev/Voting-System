...
INSERT INTO dishes (restaurant_id, description, price, date) VALUES
  (100003, 'Steak', 350,           '2018-12-04'),
  (100003, 'Tomato soup', 150,     '2018-12-04'),
  (100003, 'Espresso', 100,        '2018-12-04'),
  (100003, 'Cheese Toast', 110,    '2018-12-04'),
  (100004, 'Vegetable salad', 200, '2018-12-04'),
  (100004, 'Fish', 250,            '2018-12-04'),
  (100004, 'Ice tea', 70,          '2018-12-04'),
  (100004, 'Gazpacho', 300,        '2018-12-04'),
  (100004, 'Cheesecake', 130,      '2018-12-04');
